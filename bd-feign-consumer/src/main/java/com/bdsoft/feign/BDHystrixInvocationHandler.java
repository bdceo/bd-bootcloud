 ...
 * @version 1.0
 * @auth 丁辰叶
 * @date 2017/9/27 18:29
 */
public class BDHystrixInvocationHandler implements InvocationHandler {
    ...
    BDHystrixInvocationHandler(Target<?> target, Map<Method, InvocationHandlerFactory.MethodHandler> dispatch,
    ...
    public Object invoke(final Object proxy, final Method method, final Object[] args)
        ...
        HystrixCommand<Object> hystrixCommand = new HystrixCommand<Object>(setterMethodMap.get(method)) {
            ...
            protected Object run() throws Exception {
                try {
                    return BDHystrixInvocationHandler.this.dispatch.get(method).invoke(args);
                } catch (Exception e) {
                    throw e;
                } catch (Throwable t) {
                    throw (Error) t;
    ...
    public boolean equals(Object obj) {
        if (obj instanceof BDHystrixInvocationHandler) {
            BDHystrixInvocationHandler other = (BDHystrixInvocationHandler) obj;
